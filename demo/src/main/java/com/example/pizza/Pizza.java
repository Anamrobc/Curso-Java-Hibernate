...
public class Pizza extends EntityBase {
    ...
    //Se utiliza un patrón Builder si hay muchas propiedades en la clase, para no hacer el new() para instanciarla.
    //Se asignan los valores de las propiedades en una misma sentencia
